...
export const PROJECTS = [
  {
    slug: 'ff-search', title: 'FF Search', client: 'FF Dev Studio', zone: 'study', year: 2026,
  ...
  {
    slug: 'ff-shoots', title: 'FF Shoots', client: 'FF Dev Studio', zone: 'study', year: 2026,
  ...
  {
    slug: 'ff-stanzza', title: 'FF Stanzza', client: 'FF Dev Studio', zone: 'study', year: 2026,
  ...
  {
    slug: 'ff-frames', title: 'FF Frames', client: 'FF Dev Studio', zone: 'study', year: 2026,
  ...
  {
    slug: 'sunlight-supplies', title: 'Sunlight Supplies', client: 'Sunlight Supplies', zone: 'client', year: 2026,
  ...
  {
    slug: 'lewix-ai', title: 'Lewix.ai', client: 'Lewix.ai', zone: 'product', year: 2026,
  ...
  {
    slug: 'smoothsail', title: 'SmoothSail', client: 'Lewix.ai', zone: 'product', year: 2026,
  ...
  {
    slug: 'big-brain-furniture', title: 'Big Brain Furniture', client: 'TGS Furnishings', zone: 'client', year: 2026,
  ...
  {
    slug: 'ascend-peptides', title: 'Ascend Peptides', client: 'Ascend Peptides', zone: 'client', year: 2026,
  ...
  {
    slug: 'lewix-my', title: 'Lewix', client: 'Lewix.ai', zone: 'product', year: 2026,
  ...
  {
    slug: 'meridian', title: 'Meridian', client: 'FF Dev Studio', zone: 'study', year: 2026,
  ...
  {
    slug: 'big-brain-furniture-alt', title: 'Big Brain, second direction', client: 'TGS Furnishings', zone: 'client', year: 2026,
  ...
  {
    slug: 'obys-translation', title: 'Obys translation', client: 'FF Dev Studio', zone: 'study', year: 2026,
  ...
  {
    slug: 'basement-translation', title: 'Basement translation', client: 'FF Dev Studio', zone: 'study', year: 2026,
...
export const shotUrl = (p, i) => `/media/${p.slug}/w-${i}.jpg`;
